...
Automatically registers the new slide in presentation.xml.
"""
...
def _register_in_presentation(unpacked_dir: Path, slide_id: int, rid: str) -> None:
    pres_path = unpacked_dir / "ppt" / "presentation.xml"
    ...
    print(f"Registered in presentation.xml: id={slide_id} r:id={rid}")
