...
렌더링 시 콘텐츠 길이에 따라 3단계로 판단:
1. **14pt, 1장** (기본): `sz="1400"` — 마크다운 ~25줄 이하
2. **12pt, 1장** (약간 넘침): `sz="1200"` — 마크다운 ~35줄 이하
3. **14pt, 2장** (많이 넘침): `sz="1400"` 유지, 섹션 헤더 경계에서 분할 — 35줄 초과
